...
public class HttpRequest {
    ...
    public static String sendGet(String url, String param) {
        ...
        try {
            ...
            String encoding = DatatypeConverter.printBase64Binary((new StringBuilder(String.valueOf("admin"))).append(":").append("admin888").toString().getBytes("UTF-8"));
            connection.setRequestProperty("Authorization",(new StringBuilder("Basic ")).append(encoding).toString());
            // 建立实际的连接
            connection.connect();
            // 获取所有响应头字段
